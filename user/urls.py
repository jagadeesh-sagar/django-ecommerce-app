...
urlpatterns=[
    ...
    path('product/request-delete-otp/<int:product>/<int:variant>/',product_views.product_delete_otp_view,name='product-variant-delete-otp'),
    path('product/confirm-delete/<int:product>/<int:variant>/',product_views.product_delete_confirm_view,name='product-variant-delete-confirm'),
